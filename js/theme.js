...
(function(theme, $) {
    ...
    PluginMasonry.prototype = {
        ...
        build: function() {
            ...
            self.options.wrapper.one("layoutComplete", function(
                event,
                laidOutItems
            ) {
                self.removeLoader();
    ...
    PluginSort.prototype = {
        ...
        build: function() {
            ...
            if ($destination.get(0)) {
                ...
                $destination.one("layoutComplete", function(
                    event,
                    laidOutItems
                ) {
                    self.removeLoader();
                        ...
                        menuNav: function() {
                            ...
                            self.$mainNavItem.on("click", function(e) {
                                var currentMenuItem = $(this),
                                    ...
                                    isBack = currentMenuItem.hasClass(
                                        "back-button"
                                    ),
                                    nextMenuHeightDiff =
    ...
    $.extend(theme, {
        StickyHeader: {
            ...
            build: function() {
                    ...
                    if (self.options.stickyEffect == "shrink") {
                        ...
                        if (self.options.stickyHeaderContainerHeight) {
                            self.options.wrapper.find(".header-container").css({
                                height:
                                    self.options.stickyHeaderContainerHeight,
                                "min-height": 0
                            });
                        } else {
                            self.options.wrapper.find(".header-container").css({
                ...
                // Set Logo
                if (self.options.stickyChangeLogo) {
                    var $logoWrapper = self.options.wrapper.find(
                            ".header-logo"
                        ),
